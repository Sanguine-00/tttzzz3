...
> [![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/Sanguine-00/tttzzz3)
...
| 变量 | 默认值 | 说明 |
| :--- | :--- | :--- |
| `ID` | `6499834c-1bc1-4bfb-a434-047751bb03bf` | VMess 用户主 ID，用于身份验证，为 UUID 格式 |
| `WSPATH` | `/wapsd.189.cn` | WebSocket 所使用的 HTTP 协议路径 |
